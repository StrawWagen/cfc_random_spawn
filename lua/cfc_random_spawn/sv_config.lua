...
CFCRandomSpawn.Config.CUSTOM_SPAWNS["gm_novenka"] = {
    ...
    { spawnPos = Vector( 7265, 5878, -383 ), spawnAngle = Angle( 0, 0, 45 ), pvp = true },	
    { spawnPos = Vector( 6052, 11677, -383 ), spawnAngle = Angle( 0, 0, -135 ), pvp = true },	
    { spawnPos = Vector( 5334, 11687, -383 ), spawnAngle = Angle( 0, 0, -45 ), pvp = true },	
    { spawnPos = Vector( 8486, 5880, -383 ), spawnAngle = Angle( 0, 0, 155 ), pvp = true },	
    { spawnPos = Vector( 4475, 8824, -127 ), spawnAngle = Angle( 0, 0, 59 ), pvp = true },	
    { spawnPos = Vector( 6364, 10733, -383 ), spawnAngle = Angle( 0, 0, -90 ), pvp = true },	
    { spawnPos = Vector( 5578, 6911, -383 ), spawnAngle = Angle( 0, 0, 45 ), pvp = true },	
    { spawnPos = Vector( 4884, 11390, -383 ), spawnAngle = Angle( 0, 0, -45 ), pvp = true },	
    { spawnPos = Vector( 4497, 9553, -127 ), spawnAngle = Angle( 0, 0, 8 ), pvp = true },	
    { spawnPos = Vector( 8995, 6627, -383 ), spawnAngle = Angle( 0, 0, 135 ), pvp = true },	
    { spawnPos = Vector( 4875, 10749, -383 ), spawnAngle = Angle( 0, 0, 42 ), pvp = true },	
    { spawnPos = Vector( 9043, 9799, -383 ), spawnAngle = Angle( 0, 0, 124 ), pvp = true },	
    { spawnPos = Vector( 7648, 10733, -383 ), spawnAngle = Angle( 0, 0, -90 ), pvp = true },	
    { spawnPos = Vector( 5654, 8670, -383 ), spawnAngle = Angle( 0, 0, 0 ), pvp = true },	
    { spawnPos = Vector( 8989, 9103, -383 ), spawnAngle = Angle( 0, 0, -135 ), pvp = true },	
    { spawnPos = Vector( 8984, 7792, -383 ), spawnAngle = Angle( 0, 0, -180 ), pvp = true },	
    { spawnPos = Vector( 5121, 8820, -127 ), spawnAngle = Angle( 0, 0, 90 ), pvp = true },	
    { spawnPos = Vector( 9024, 10741, -383 ), spawnAngle = Angle( 0, 0, -148 ), pvp = true },	
    { spawnPos = Vector( 6417, 5878, -383 ), spawnAngle = Angle( 0, 0, 135 ), pvp = true },	
}
